...
└── src/99_interview-qna/    → Interview prep (active; `99_` sorts after curriculum scaffolds) — README workflow, `01_interview-prep-conventions.md`, role tracks `01_`–`09_`, `interview-execution/`, career-orientation
```

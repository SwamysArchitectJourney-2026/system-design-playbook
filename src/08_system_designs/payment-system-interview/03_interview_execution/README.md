...
**Track modules:** `../01_foundations/` modules `01`–`06` (requirements → components → idempotency → grill → mock debrief → 5-min drill), plus `../02_core_questions/design-payment-azure-e2e/`.
